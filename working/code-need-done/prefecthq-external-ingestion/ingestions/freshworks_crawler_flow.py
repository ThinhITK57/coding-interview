...
@flow(log_prints=True, name="[Hourly]-Minio Deals Freshwork APIs - Data Lake")
def run_daily_scrapping_freshworks_crawler():
    ...
    filename = os.path.join(RESOURCE_BASE_DIR, "resources-crm.json")
...
@flow(log_prints=True, name="[Weekly]-Minio Settings Freshwork APIs - Data Lake")
...
@flow(log_prints=True, name="[Adhoc]-Minio Sync freshwork table from scratch")
