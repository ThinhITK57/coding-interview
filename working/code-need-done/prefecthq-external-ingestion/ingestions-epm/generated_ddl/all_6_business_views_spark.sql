...
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_bsc_yearly AS
SELECT
...
LEFT JOIN bi_silver.epm_assignments a
...
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_dieu_hanh_cvct_klcd AS
SELECT
...
-- BR-03: Báo cáo Task
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_task_report AS
SELECT
    t.task_type,
...
-- BR-04: Báo cáo Dự án
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_project_report AS
SELECT
    p.name,
...
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_user_access_traffic AS
SELECT
...
-- -----------------------------------------------------------------------------
CREATE OR REPLACE VIEW bi_gold.vw_board_objectives AS
SELECT
    t.associated_objective,
    t.associated_item,
    t.target_type,
