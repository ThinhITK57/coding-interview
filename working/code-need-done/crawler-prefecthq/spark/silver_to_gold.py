...
def build_br01_bsc_yearly(targets_df, assignments_df):
    """
...
def build_br02_dieu_hanh_cvct_klcd(targets_df):
    """
...
def build_br06_board_objectives(targets_df, assignments_df):
    """
...
def main():
    ...
    br01 = build_br01_bsc_yearly(targets_df, assignments_df)
    br02 = build_br02_dieu_hanh_cvct_klcd(targets_df)
    ...
    br06 = build_br06_board_objectives(targets_df, assignments_df)

    # 3. Save to Gold Layer
    results = {}
    results["bsc_yearly"] = save_gold_table(br01, args.gold_path, "bsc_yearly")
    results["dieu_hanh_cvct_klcd"] = save_gold_table(br02, args.gold_path, "dieu_hanh_cvct_klcd")
    results["task_report"] = save_gold_table(br03, args.gold_path, "task_report")
    results["project_report"] = save_gold_table(br04, args.gold_path, "project_report")
    results["user_access_traffic"] = save_gold_table(br05, args.gold_path, "user_access_traffic")
    results["board_objectives"] = save_gold_table(br06, args.gold_path, "board_objectives")
