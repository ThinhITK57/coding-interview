...
spark.sql("DROP VIEW IF EXISTS bi_gold.finance_allocated_revenue")

spark.sql("""
CREATE OR REPLACE VIEW bi_gold.finance_allocated_revenue  AS
SELECT 
    ...
    revenue_amount
FROM bi_silver.finance_allocated_revenue
""")