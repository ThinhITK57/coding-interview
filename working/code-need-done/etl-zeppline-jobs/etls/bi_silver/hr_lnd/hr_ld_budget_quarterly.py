...
# Source & Target
src_hr_table = "hr_raw.hr_training_budget_summary_by_quarter"
tgt_hr_table = "bi_silver.hr_ld_budget_quarterly"
tgt_fin_path = "/opt/datasets/crawlers/vcs_silver/bi_silver/data/hr_ld_budget_quarterly"
...
""".format(tgt_hr_table, tgt_fin_path)
