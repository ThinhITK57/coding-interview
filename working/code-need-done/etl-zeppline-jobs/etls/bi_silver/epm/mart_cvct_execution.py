...
tgt_table = "bi_silver.epm_mart_cvct_execution_report"
tgt_path  = "/opt/datasets/crawlers/vcs_silver/bi_silver/data/epm_mart_cvct_execution_report"
...
# Tạo alias tương thích ngược cho tên cũ
