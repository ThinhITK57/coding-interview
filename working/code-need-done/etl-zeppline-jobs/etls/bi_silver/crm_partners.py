...
tgt_path  = "/opt/datasets/crawlers/vcs_silver/bi_silver/data/crm_partners"
...
SELECT
  ...
  CAST(p.custom_field.cf_effective_date  AS TIMESTAMP) AS effective_date,
  CAST(p.custom_field.cf_expiration_date AS TIMESTAMP) AS expiration_date,
