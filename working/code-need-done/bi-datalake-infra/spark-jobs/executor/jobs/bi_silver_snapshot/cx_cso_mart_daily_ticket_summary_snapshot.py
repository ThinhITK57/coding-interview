...
target_table = "bi_silver_snapshot.cx_cso_mart_daily_ticket_summary_snapshot"
target_path = "s3a://vcs-silver/bi-silver-snapshot/cx_cso_mart_daily_ticket_summary_snapshot"
