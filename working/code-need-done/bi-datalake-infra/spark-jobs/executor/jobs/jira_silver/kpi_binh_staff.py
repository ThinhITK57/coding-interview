...
spark.sql("drop  table IF EXISTS jira_silver.kpi_binh_staff")
...
--    update_date          AS update_date_str,
    ...
    CAST(update_start_date AS TIMESTAMP) AS update_start_date_time,
    CAST(update_date       AS TIMESTAMP) AS update_date_time,
...
df.write \
    ...
    .option(
        "path",
        "s3a://vcs-silver/jira-silver/kpi_binh_staff"
    ) \
    .saveAsTable("jira_silver.kpi_binh_staff")
