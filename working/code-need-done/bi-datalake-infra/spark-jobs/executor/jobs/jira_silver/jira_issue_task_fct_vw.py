...
spark.sql("drop  table IF EXISTS jira_silver.jira_issue_task_fct_vw")
 
sql_query = """

-- CREATE VIEW jira_silver.jira_issue_task_fct_vw AS
SELECT
    'BUG'              AS source_type,
    issue_key,
    project_key,
...
df.write \
    ...
    .option(
        "path",
        "s3a://vcs-silver/jira-silver/jira_issue_task_fct_vw"
    ) \
    .saveAsTable("jira_silver.jira_issue_task_fct_vw")
