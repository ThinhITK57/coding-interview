...
spark.sql("drop  table IF EXISTS jira_silver.jira_kpi_fct_vw")
 
sql_query = """

-- CREATE VIEW jira_silver.jira_kpi_fct_vw AS
SELECT
    'KQI'                      AS kpi_type,
    issue_key,
    summary,
...
df.write \
    ...
    .option(
        "path",
        "s3a://vcs-silver/jira-silver/jira_kpi_fct_vw"
    ) \
    .saveAsTable("jira_silver.jira_kpi_fct_vw")
