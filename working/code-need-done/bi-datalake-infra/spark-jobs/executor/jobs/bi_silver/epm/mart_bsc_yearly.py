...
tgt_table = "bi_gold.bsc_yearly"
tgt_path  = "/opt/datasets/crawlers/vcs_silver/bi_gold/data/bsc_yearly"
...
spark.sql(f"CREATE OR REPLACE VIEW bi_silver.epm_mart_bsc_yearly AS SELECT * FROM {tgt_table}")
