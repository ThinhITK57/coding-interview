CREATE TABLE IF NOT EXISTS csv_finance_raw.raw_doanh_thu_cong_ty_t5_2025_shared (
  ...
  ghi_chu DOUBLE
        ...
        USING PARQUET
        LOCATION '/opt/datasets/crawlers/vcs/excels/data/doanh_thu_cong_ty_t5_2025_shared'