...
select
    ...
    coalesce(t.manager, t.c_assignee, 'Unknown')                                            as assignee_name,
...
left join {{ source('bi_silver__epm', 'epm_projects') }} p
    on t.parent_project = p.sysid
