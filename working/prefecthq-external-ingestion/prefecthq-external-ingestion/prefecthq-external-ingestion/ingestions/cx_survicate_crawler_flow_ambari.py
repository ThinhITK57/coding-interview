...
from common.survicate_helper_ambari import *
...
@flow(log_prints=True, name="[Hourly]-Ambari CX Survicate APIs - Data Lake")
def run_scrapping_survicate_crawler():
    ...
    filename = os.path.join(RESOURCE_BASE_DIR, "resources-cx-survicate-ambari.json")
...
if __name__ == "__main__":
    run_scrapping_survicate_crawler.serve(
        name="[Hourly]-Ambari CX Survicate APIs - Data Lake",
        cron="0 * * * *",
